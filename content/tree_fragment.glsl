...
void main() 
{
    ...
    vec3 camDir = normalize(cameraPosition-vNormal);
    ...
    // Generate bark pattern and apply lighting
    vec3 barkPattern = TreeBarkPattern(vPosition, vTCoord.xy, 1.0);
    color = vec4(barkColor * totalLightContribution * barkPattern, 1.0);
}
